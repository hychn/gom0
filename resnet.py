...
n_block=1; n_feat_in=32; n_feat_block=32; block_type='orig'; p_drop=.1
ResidualNetwork(n_block, n_feat_in, n_feat_block, n_feat_out=37, block_type=block_type, p_drop=p_drop)
# original resblock
