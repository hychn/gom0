...
def UCB1(x_i,n_i,N, C_p = 1 ):
    # C_p exploration parameter
    return x_i + 2*C_p*sqrt( 2*divide(ln(N),n_i) )
    #Let's look at this. at what point does experimentation preferred over going by guaranteed out?
